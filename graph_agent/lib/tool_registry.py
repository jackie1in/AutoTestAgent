...
class ToolRegistry:
    ...
    def create_action_union(self) -> type[BaseModel]:
        ...
        return Annotated[union_type, Field(discriminator="action_type")]
    ...
    async def execute(
        ...
        if "session" in sig.parameters:
            kwargs["session"] = controller._session if hasattr(controller, "_session") else None
...
def action(description: str, param_model: type[BaseModel] | None = None, terminates: bool = False):
