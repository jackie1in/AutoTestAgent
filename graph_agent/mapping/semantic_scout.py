...
class SemanticScout:
    ...
    INTERACTIVE_ROLES: Set[str] = {"button", "link", "textbox", "combobox", "checkbox", "radio", "menuitem"}
    SEMANTIC_CONTAINERS: Set[str] = {"form", "dialog", "nav", "region", "main", "header", "footer"}
    ...
    def filter_interactive_elements(self, aom_node: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
    ...
    def _enrich_with_parents(self, aom_node: Dict[str, Any], parent: Optional[Dict[str, Any]] = None) -> None:
        """
