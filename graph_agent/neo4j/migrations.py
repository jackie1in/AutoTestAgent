...
async def migrate_database(driver: Any, target_version: str | None = None) -> list[str]:
    ...
    Usage:
        from graph_agent.neo4j.migrations import migrate_database
...
async def rollback_database(driver: Any, version: str) -> list[str]:
    ...
    Usage:
        from graph_agent.neo4j.migrations import rollback_database
...
async def migration_status(driver: Any) -> dict[str, Any]:
    ...
    Usage:
        from graph_agent.neo4j.migrations import migration_status
